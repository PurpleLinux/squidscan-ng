...
def scan_proxy(target):
    common_ports = {21,22,23,25,53,69,80,109,110,123,137,138,139,143,156,389,443,546,547,995,993,2086,2087,2082,2083,3306,8080,8443,9000,9090,10000}
    proxies = set_proxy(options.creds, options.proxy)
    for i in sorted(common_ports):
        port = str(i)
